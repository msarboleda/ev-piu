<?php
  ...
  $readOnly = isset($user->role_id) && $user->role_id != 1 ? 'readonly' : '';
?>

<div class="form-group <?php echo form_error('email') ? $errorClass : ''; ?>">
  <label for="email"><?php echo lang('bf_email'); ?></label>
  <input type="text" id="email" class="form-control <?php echo $controlClass; ?>" name="email" value="<?php echo set_value('email', isset($user) ? $user->email : ''); ?>" <?php echo $readOnly; ?>/>
...
<div class="form-group <?php echo form_error('display_name') ? $errorClass : ''; ?>">
  ...
  <input type="text" id="display_name" class="form-control <?php echo $controlClass; ?>" name="display_name" value="<?php echo set_value('display_name', isset($user) ? $user->display_name : ''); ?>" <?php echo $readOnly; ?>/>
...
<div class="form-group <?php echo form_error('username') ? $errorClass : ''; ?>">
  ...
  <input type="text" id="username" class="form-control <?php echo $controlClass; ?>" name="username" value="<?php echo set_value('username', isset($user) ? $user->username : ''); ?>" <?php echo $readOnly; ?>/>
...
<div class="form-group <?php echo form_error('timezones') ? $errorClass : ''; ?>">
  ...
  echo timezone_menu(
    ...
    "form-control",
    'timezones',
    array('id' => 'timezones', $readOnly => $readOnly)
  );
  ?>
